...
import com.hxsn.farmage.myview.ViewfinderView;
import com.hxsn.farmage.utils.CameraManager;
import com.hxsn.farmage.utils.CaptureActivityHandler;
import com.hxsn.farmage.utils.GetURL;
import com.hxsn.farmage.utils.InactivityTimer;
import com.hxsn.farmage.utils.RGBLuminanceSource;
                        		...
                        		try {
							      j = new JSONObject(response);
									if (j.getString("code").equals("200")) {
									             ...
									             Intent inte = new Intent(CaptureActivity.this, HomeActivity.class);
												 startActivity(inte);
									} 
									else
									{
