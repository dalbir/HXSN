...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		canvas.drawRect(frame.right -14, frame.top+15, width, frame.bottom - 14,
				paint);
		...
		if (resultBitmap != null) {
            ...
            canvas.drawBitmap(((BitmapDrawable)(getResources().getDrawable(R.drawable.fgx))).getBitmap(), null, lineRect, paint);
...
//			
			...
			canvas.drawRect(frame.left+15,  frame.top+15,
					frame.right-15, frame.bottom-15, paint);
