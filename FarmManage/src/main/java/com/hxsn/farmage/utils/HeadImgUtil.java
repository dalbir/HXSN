...
public class HeadImgUtil {
	...
	public HeadImgUtil(String userID, String url, ImageView headImg, Context context) {
		...
		filePath = SDCardUtil.getInnerSDCardPath() + "/Farmage/";
	...
	public static void headDelete(String userID) {
		String imgPath = SDCardUtil.getInnerSDCardPath() + "/Farmage/head/" + userID + ".jpeg";
	...
	public static String getImgParentPath() {
		String imgParentPath = SDCardUtil.getInnerSDCardPath() + "/Farmage/head/";
		return imgParentPath;
	}
	
	public static void save(Bitmap bp, String imgParentPath, String imgName) {
