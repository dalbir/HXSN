...
import com.hxsn.ssk.utils.DateUtil;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.txt_send:
                ...
                map.put("userid", TApplication.user.getId());
                map.put("username", TApplication.user.getName());
                ...
                }.doPostRequest(url, "filedata", new File(imgPath), map);
