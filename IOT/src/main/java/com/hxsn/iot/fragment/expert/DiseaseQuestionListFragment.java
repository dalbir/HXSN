...
public class DiseaseQuestionListFragment extends AbsBaseFgt {
	private View view;
	...
	private void initData() {
		queId = getArguments().getString("id");
		backId = getArguments().getString("backId");
	    ParseDatas parse = DataController.getDiseaseQuestionList(queId);
	    if(parse != null){
	...
	private void initView() {
		...
		title.setText("问题列表");
		navOne.setBackgroundDrawable(getResources().getDrawable(R.drawable.expert_disease_navigation_gray));
		navTwo.setBackgroundDrawable(getResources().getDrawable(R.drawable.expert_disease_navigation_gray));
		navThree.setBackgroundDrawable(getResources().getDrawable(R.drawable.expert_disease_navigation_blue));
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				bundle.putString("backId", queId);
				mListener.onArticleSelected("com.snsoft.aiot.phone.fragment.ExpertMainTop","com.snsoft.aiot.phone.expert.DiseaseQuestionDataFragment", bundle);
			}
		});
		...
		backBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//mListener.onArticleSelectedBack("com.snsoft.aiot.phone.expert.DiseaseListFragment", bundle);
