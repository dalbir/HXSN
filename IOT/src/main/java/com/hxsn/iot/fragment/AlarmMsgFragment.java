...
public class AlarmMsgFragment extends AbsBaseFgt {
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.alarm_msg_layout, container, false);
		initView();
		return view;
	}
        ...
        listAll.setListner(new SwipeListView.OnloadListner(){
			...
			public void loadMore() {
				...
				new Thread(new Runnable(){
					...
					public void run() {
						// TODO Auto-generated method stub
						ArrayList<HashMap<String, String>> list = DataConnection.conDbPhoneAlarmOfType(getActivity(), listSizeAll, "all");
			...
			public void loadNew() {
				...
				new Thread(new Runnable(){
					...
					public void run() {
						...
						Looper.prepare();
						requestNew();
						ArrayList<HashMap<String, String>> list = DataConnection.conDbPhoneAlarmOfType(getActivity(),0,"all");
						Message msg = new Message();
        ...
        listReaded.setListner(new SwipeListView.OnloadListner(){
			...
			public void loadMore() {
				...
				new Thread(new Runnable(){
					...
					public void run() {
						// TODO Auto-generated method stub
						ArrayList<HashMap<String, String>> list = DataConnection.conDbPhoneAlarmOfType(getActivity(),listSizeReaded,"readed");
						Message msg = new Message();
			...
			public void loadNew() {
				...
				new Thread(new Runnable(){
					...
					public void run() {
						...
						Looper.prepare();
						requestNew();
						ArrayList<HashMap<String, String>> list = DataConnection.conDbPhoneAlarmOfType(getActivity(),0,"readed");
						Message msg = new Message();
        ...
        listToday.setListner(new SwipeListView.OnloadListner(){
			...
			public void loadMore() {
				...
				new Thread(new Runnable(){
					...
					public void run() {
						// TODO Auto-generated method stub
						ArrayList<HashMap<String, String>> list = DataConnection.conDbPhoneAlarmOfType(getActivity(),listSizeToday,"today");
						Message msg = new Message();
			...
			public void loadNew() {
				...
				new Thread(new Runnable(){
					...
					public void run() {
						...
						Looper.prepare();
						requestNew();
						ArrayList<HashMap<String, String>> list = DataConnection.conDbPhoneAlarmOfType(getActivity(),0,"today");
						Message msg = new Message();
						msg.obj = list;
	...
	private void initData(){
		arrayAll = DataConnection.conDbPhoneAlarmOfType(getActivity(),0,"all");
		listSizeAll = arrayAll.size();
        arrayReaded = DataConnection.conDbPhoneAlarmOfType(getActivity(),0,"readed");
        listSizeReaded= arrayReaded.size();
        arrayToday = DataConnection.conDbPhoneAlarmOfType(getActivity(),0,"today");
        ...
        if(arrayReaded == null){
        	...
        	listReaded.setOnItemClickListener(new OnItemClickListener() {
    			...
    			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
    					long arg3) {
    				int position = arg2-listReaded.getHeaderViewsCount();
    				String id= readedAdapter.getMsgid(position);//报警详情msgid
    				//getContentView(id,position);
    				DataConnection.conUpdateReadAlarm(getActivity(), id);
    				ViewHolder holder = (ViewHolder) arg1.getTag();
    				holder.readState.setText("已读");
        ...
        if(arrayToday == null){
        	...
        	listToday.setOnItemClickListener(new OnItemClickListener() {
    			...
    			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
    					long arg3) {
    				int position = arg2-listToday.getHeaderViewsCount();
    				String id= todayAdapter.getMsgid(position);//报警详情msgid
    				//getContentView(id,position);
    				DataConnection.conUpdateReadAlarm(getActivity(), id);
    				HashMap<String, String> item = (HashMap<String, String>) allAdapter.getItem(position);
    				item.put("status", "readed");
	...
	private void getContentView(final String msgid, final int position) {
		...
		//Intent intent = new Intent(getActivity(), AlarmContentActivity.class);
	...
	public void onResume() {
		// TODO Auto-generated method stub
		Log.i("Resume", "listAll:" + arrayAll.size() + ":" + listSizeAll);
		super.onResume();
	}
	...
	public void requestNew(){
		...
		try {
			DataConnection.conUpdateDbPhoneAlarmByIemi(getActivity(), AbsApplication.getInstance().getImei(), date);
		} catch (Exception e) {
