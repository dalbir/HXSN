...
public class DiseaseListFragment extends AbsBaseFgt {
	private View view;
	...
	private void initData() {
		disId = getArguments().getString("id");
	    ParseDatas parse = DataController.getDiseaseList(disId);
	    if(parse != null){
	...
	private void initView() {
		...
		navTwo.setBackgroundDrawable(getResources().getDrawable(R.drawable.expert_disease_navigation_blue));
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				bundle.putString("backId", disId);
				mListener.onArticleSelected("com.snsoft.aiot.phone.fragment.ExpertMainTop","com.snsoft.aiot.phone.expert.DiseaseQuestionListFragment", bundle);
			}
		});
		...
		backBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				//mListener.onArticleSelectedBack("com.snsoft.aiot.phone.expert.DiseaseSearchFragment", null);
