...
public class QuestionDetailFragment extends AbsBaseFgt {
	private View view;
	...
	private void initView() {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//mListener.onArticleSelectedBack("com.snsoft.aiot.phone.expert.QuestionListFragment", questionBundle);
	...
	private void initData(){
		...
		ArrayList<HashMap<String,String>> aList = (ArrayList<HashMap<String,String>>)al.get(0);
		detail = DataController.getDetailQuestion(aList.get(position).get("id"));
		if(detail != null){
